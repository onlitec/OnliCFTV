...
|---|---|---|
| [**OnliView_0.1.5_x64-setup.exe**](https://github.com/onlitec/OnliCFTV/releases/latest/download/OnliView_0.1.5_x64-setup.exe) | **Instalador Oficial (NSIS)** | Assistente completo com atalhos no Desktop/Menu Iniciar, desinstalador e motor FFmpeg embutido |
| [**OnliView_Windows_Portable_v0.1.5.zip**](https://github.com/onlitec/OnliCFTV/releases/latest/download/OnliView_Windows_Portable_v0.1.5.zip) | **Pacote Portátil (ZIP)** | Execução direta sem instalação (inclui `onliview.exe` e binários do motor de vídeo) |

### 🐧 Linux (Ubuntu / Debian / Fedora / RedHat)
| Pacote | Tipo | Comando de Instalação |
|---|---|---|
| [**OnliView_0.1.5_amd64.deb**](https://github.com/onlitec/OnliCFTV/releases/latest/download/OnliView_0.1.5_amd64.deb) | Pacote Debian/Ubuntu | `sudo dpkg -i OnliView_0.1.5_amd64.deb` |
...
\* AppImage e RPM ainda não foram recompilados com as últimas correções (v0.1.5); use o `.deb` para a versão mais atual no Linux.
